# contour detection for a single image
import csv
import cv2
...
#static image route of the 1 image
...
#view and choose what to call the new image
cv2.imshow('image', imgCanny)
cv2.imwrite('data/newImage.jpeg', imgCanny)
